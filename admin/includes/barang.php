...
=======
  ...
  <a href="?p=tambah-barang&id_lab=<?echo$_GET['id_lab'];?>" class="btn btn-primary btn-sm float-right">Tambah Data</a>
  ...
  <table class="table table-sm mt-3">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <div class="d-inline">
            <a href="?p=detail-barang&id=<?= $barang['id_barang'];?>&id_lab=<?echo$_GET['id_lab'];?>" class="btn btn-primary btn-sm">Detail</a>
